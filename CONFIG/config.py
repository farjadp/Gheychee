...
class Config(object):
    ...
    from CONFIG.constants import BOT_NAME, BOT_NAME_FOR_USERS, ADMIN, ADMIN_USERNAME
    BOT_NAME = BOT_NAME
    # A name for users - Required (str)
    BOT_NAME_FOR_USERS = BOT_NAME_FOR_USERS #name in database
    ...
    # API HASH Telegram
    API_HASH = _env("API_HASH", "CHANGE_ME")
    # Bot token
    BOT_TOKEN = _env("BOT_TOKEN", "00000000000:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
    # Mini-app URL
    ...
    SUBSCRIBE_CHANNEL_URL = "https://t.me/@heroes_journey"
    ...
    DASHBOARD_PORT = _env_int("DASHBOARD_PORT", 5555)
