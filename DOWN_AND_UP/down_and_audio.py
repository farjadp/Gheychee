        ...
        def try_download_audio(url, current_index):
            ...
            try:
                ...
                if not getattr(down_and_audio, '_error_message_sent', False):
                    ...
                    send_error_to_user(
                        message,
                        "<blockquote>Check <a href='https://github.com/farjadp/tg-ytdlp-bot'>here</a> if your site supported</blockquote>\n"
                        ...
                        "<blockquote>For Youtube - get <code>cookie</code> via <b>/cookie</b> command. For any other supported site - send your own cookie (<a href='https://t.me/startupvisamentor/203'>guide1</a>) (<a href='https://t.me/startupvisamentor/214'>guide2</a>) and after that send your audio link again.</blockquote>\n"
                        f"────────────────\n"
